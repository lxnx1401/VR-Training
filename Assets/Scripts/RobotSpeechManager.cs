...
public class RobotSpeechManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Wenn gesperrt: nichts machen (Task muss erst UnlockTask() rufen)
    ...
    private IEnumerator TypeTextRoutine(DialogueLine line)
    {
        ...
        // ✅ Task-Lock pro Zeile
        // Wichtig: wir aktivieren den Lock sofort beim Start dieser Zeile,
        // damit danach nicht weitergeklickt werden kann (bis UnlockTask).
    ...
    /// <summary>
    /// Von außen aufrufen (z.B. SafeZoneController), wenn die Aufgabe erledigt ist.
    /// </summary>
